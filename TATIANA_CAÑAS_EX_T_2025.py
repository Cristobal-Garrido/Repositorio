...
#opcion 1 del menú : busca patines por marca
...
#opcion 2 de menú : indica stock por marca 
...
#opcion 3 del menú: indica modelos disponibles por talla
def cant_disp_talla():
    totalPatines=0
    while True:
        try:
...
#opción 4 del menú: busca patines en un rango de precios
...
#opción 5 del menú: busca patines por tamaño de rueda
...
#opción 6 del menú: cambia precio y cantidad por codigo
...
def Menu_principal():
    while True:
        ...
        print(" 6.- Actualizar precio y cantidad")       
        print(" 7.- Salir")
